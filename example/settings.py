...
TRAIN = {
    ...
    "use_overlap": 0,  # epoch to start using ovlp in loss evaluation, or 0 to always use it, -1 to never use it.
    # Evaluation
    ...
    "log_block_losses": True,  # whether to log the block losses
    # Masked learning
