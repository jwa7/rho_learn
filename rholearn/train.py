...
#     train_loss_epoch = 0
#     n_train_epoch = 0
#     block_losses_epoch = torch.zeros(len(model._in_metadata.keys))
#     for train_batch in train_loader:  # minibatches

#         # idxs_train, frames_train, in_train, out_train, aux_trains = train_batch
#         idxs_train, frames_train, in_train, out_train = train_batch
...
#             in_train[0]#, check_metadata=check_metadata
#         )
...
#                 idxs_val, frames_val, in_val, out_val = val_batch
#                 out_val_pred = model(in_val[0])#, check_metadata=check_metadata)  # prediction
...
#         predictions = model(descriptors[0])

#         # for pred, targ in zip(predictions, targets):
#         #     assert metatensor.equal_metadata(pred, targ)

#         assert metatensor.equal_metadata(predictions, targets[0])
